...
class Main 
{
  public static void left_rotate_even_element(int arr_size, int arr[], int  no_of_rotation)
  {
    int first_even_elem_index = 1;
    int last_even_elem_index = 0;
    if(arr_size % 2 == 0)
    {
    ...
    public static void right_rotate_odd_element(int arr_size, int arr[], int  no_of_rotation)
  {
  ...
  public static void main(String args[])
    ...
    left_rotate_even_element(arr_size, arr, no_of_rotation);
    right_rotate_odd_element(arr_size, arr, no_of_rotation);
    for(int index = 0; index<=(arr_size-1); index++)
    {
